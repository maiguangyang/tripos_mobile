...
-(BOOL)configure:(VPDInitializationParameters *)parameters model:(NSString *)model applicationVersion:(VPDVersionNumber *)applicationVersion error:(NSError **)error shouldConfirmConfiguration:(BOOL)shouldConfirmConfiguration;
...
-(BOOL)setVariable:(NSString *)variableId data:(NSString *)data error:(NSError **)error;
-(BOOL)setConnectionIndicator;
-(BOOL)isCanadaDevice:(NSString*)serialNumber model:(NSString*)model;
-(NSBundle *)getBundle;
...
@property (retain, nonatomic) NSString *firmwarePatchFileName;
...
@property (retain, nonatomic) NSArray *firmwareFilesForDeletion;

+(RbaModelInfo *)rbaModelInfoWithVersion:(NSString *)version firewareFileName:(NSString *)firmwareFileName firmwarePatchFile:(NSString *)firmwareFilePatch firmwareFilesToDelete:(NSArray *)firmwareFilesToDelete p2peEnableFileName:(NSString *)p2peEnableFileName formsFileName:(NSString *)formsFileName customPromptsFileName:(NSString *)customPromptsFileName;

+(RbaModelInfo *)rbaModelInfoWithVersion:(NSString *)version firewareFileName:(NSString *)firmwareFileName firmwarePatchFile:(NSString *)firmwareFilePatch firmwareFilesToDelete:(NSArray *)firmwareFilesToDelete p2peEnableFileName:(NSString *)p2peEnableFileName formsFileName:(NSString *)formsFileName customPromptsFileName:(NSString *)customPromptsFileName p2peEnableAlternativeFileName :(NSString *)p2peEnableAlternateFileName;

+(RbaModelInfo *)rbaModelSupportedWiFiRoaming;
