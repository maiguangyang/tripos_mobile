...
/// \param text Text that should be displayed to the user.
///
/// \param identifier Identifier that should be mapped with displayed text.
-(void)onDisplayText:(NSString *) text identifier:(VTPTextIdentifier)identifier;
