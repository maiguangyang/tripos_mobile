...
///
/// \brief Gets or sets if Hosted Surcharge is enabled.
///
/// This property gets or sets if Hosted Surcharge is enabled.
///
@property (nonatomic) BOOL isFeeAssistEnabled;
...
///
/// \brief Indicates whether the transaction should be stored when a surcharge inquiry cannot be performed and transaction storing is enabled.If set to NO, the transaction will be terminated when a surcharge inquiry cannot be performed.
///
/// Indicates whether the transaction should be stored when a surcharge inquiry cannot be performed and transaction storing is enabled.
///
@property (assign, nonatomic) BOOL proceedWithoutSurchargeOnError;
