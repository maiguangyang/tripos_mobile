...
///
/// \brief Gets or sets the device sleep timeout in seconds
///
/// This property gets or sets the device sleep timeout in seconds applicable only for Moby devices. This value should be 0-3600.
///
@property (nonatomic) int sleepTimeOutSeconds;
