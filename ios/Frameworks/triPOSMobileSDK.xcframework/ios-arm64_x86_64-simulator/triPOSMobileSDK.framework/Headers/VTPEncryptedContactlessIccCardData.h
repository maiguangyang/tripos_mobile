...
///
/// \brief Gets or sets a flag indicating if PIN data is included
///
/// This property gets or sets the encrypted pin data.
///
@property (nonatomic) BOOL isPinDataIncludedInEncryptedData;
